...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        ...
        \For{\(j = 1,\: \ldots,\: m\)}
            ...
            \For{\(i = 1,\: \ldots,\: j\)}
                \State \(\symbf{H}_{ij} = \symbf{Q}_{:i}^\top \symbf{A} \symbf{Q}_{:j}\) \Comment{Construct upper triangular entries \(h_{ij}\)}
                \State \(\symbf{Q}_{:,j+1} = \symbf{Q}_{:,j+1} - \symbf{H}_{ij} \symbf{Q}_{:j}\)
            \EndFor
            \State \(\symbf{H}_{j+1,j} = \norm*{\symbf{Q}_{:,j+1}}\) \Comment{Construct sub-diagonal entries \(h_{j+1,j}\)}
            \If{\(\symbf{H}_{j+1,j} \neq 0\)}
                \State \(\symbf{Q}_{:,j+1} = \symbf{Q}_{:,j+1} / \symbf{H}_{j+1,j}\) \Comment{Normalise \(\symbf{q}_{j+1}\)}
            \EndIf
        \EndFor
    \end{algorithmic}
\end{algorithm}
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        ...
        \For{\(j = 1,\: \ldots,\: m\)}
            \State \(\symbf{Q}_{:,j+1} = \symbf{A} \symbf{Q}_{:j}\)
            \For{\(i = 1,\: \ldots,\: j\)}
                \State \(\symbf{H}_{ij} = \symbf{Q}_{:i}^\top \symbf{Q}_{:j}\) \Comment{Construct upper triangular entries \(h_{ij}\)}
                \State \(\symbf{Q}_{:,j+1} = \symbf{Q}_{:,j+1} - \symbf{H}_{ij} \symbf{Q}_{:j}\)
            \EndFor
            \State \(\symbf{H}_{j+1,j} = \norm*{\symbf{Q}_{:,j+1}}\) \Comment{Construct sub-diagonal entries \(h_{j+1,j}\)}
            \If{\(\symbf{H}_{j+1,j} \neq 0\)}
